...
public class SmsCoupon implements Serializable {
    ...
    @Schema(name = "优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券")
    private Integer type;

    private String name;

    @Schema(name = "使用平台：0->全部；1->移动；2->PC")
    ...
    @Schema(name = "使用类型：0->全场通用；1->指定分类；2->指定商品")
