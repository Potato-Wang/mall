...
public class PmsProduct implements Serializable {
    ...
    @Schema(name = "新品状态:0->不是新品；1->新品")
    private Integer newStatus;

    @Schema(name = "推荐状态；0->不推荐；1->推荐")
    ...
    @Schema(name = "商品重量，默认为克")
    private BigDecimal weight;

    @Schema(name = "是否为预告商品：0->不是；1->是")
    private Integer previewStatus;

    @Schema(name = "以逗号分割的产品服务：1->无忧退货；2->快速退款；3->免费包邮")
    ...
    @Schema(name = "画册图片，连产品图片限制为5张，以逗号分割")
    ...
    @Schema(name = "促销类型：0->没有促销使用原价;1->使用促销价；2->使用会员价；3->使用阶梯价格；4->使用满减价格；5->限时购")
